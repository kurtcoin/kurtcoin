...
{
    const char* pszTimestamp = "Kurtcoin 2026: The Wolfpack Awakens - Loyalty, Freedom and Decentralization";
    const CScript genesisOutputScript = CScript() << "020318742db14cc3d9d46a398b335ef49090ae8d8a519090d0db7eda921f344182"_hex << OP_CHECKSIG;
...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        consensus.nPowTargetSpacing = 1 * 60; // 1 Dakika blok süresi (Hızlı transfer)
        ...
        consensus.defaultAssumeValid = uint256{"00000ad4b509810ffa3bb36aa5071e885a34ca424d94820b44bb0c3d589364dc"};

        /**
         * Kurtcoin Magic Bytes: 'KURT' (0x4b, 0x55, 0x52, 0x54)
         */
        ...
        genesis = CreateGenesisBlock(1787647601, 3278766, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000ad4b509810ffa3bb36aa5071e885a34ca424d94820b44bb0c3d589364dc"});
        assert(genesis.hashMerkleRoot == uint256{"9ad9c01475d6c503610d705000accad383aebb190ce499f5b76fbfa605ed60dc"});
